...
export function initialState(): AppState {
  ...
  return { scenarios: [seed, bank, seedDiaScenario(), seedOpenBookingScenario(), seedSingleScenario()], activeId: seed.id, compareIds: [seed.id, bank.id], wizardDone: false, showPerPartner: false }
}
