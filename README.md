...
- **CPF.**
  ...
  - **Turning 55 isn't simulated.** At 55, CPF moves SA then OA savings into a new Retirement Account up to the Full Retirement Sum ($220,400); OA contributions after 55 can still pay the loan. The app doesn't track SA, so it warns instead (and suggests applying to CPF, within 6 months before 55, to reserve OA savings for housing payments): a warning if someone turns 55 within the plan while CPF pays the mortgage (OA shown after that may be too high), a note if it happens later but before the loan ends.
